...
def main() -> None:
    ...
    if not args.macro.exists():
        raise FileNotFoundError(
            f"Macro file not found: {args.macro}. Run: python fetch_macro_1_year.py --start 2025-01-25 --end 2026-01-25"
        )
    ...
    print("\n[INFO] Next steps:")
    print(f"  python prepare_gold_dss_pipeline.py --input-dir {args.output_dir} --output-file master_dss_dataset_1year.csv")
    print("  Then train: cd \"New folder\" && python train_xgboost_dss.py --hold-band 0.2 ... (with master_dss_dataset_1year.csv)")
